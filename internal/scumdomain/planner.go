...
var routeSpecs = []RouteSpec{
	...
	{Domain: "logs", Method: http.MethodGet, Route: "logs", Title: "日志", Capability: "file.read", Operation: "read", Permission: "scum.logs.read", RiskLevel: riskMedium, Summary: "读取实例日志目录中的真实文件"},
